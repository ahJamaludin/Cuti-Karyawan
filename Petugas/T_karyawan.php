        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="T_karyawan.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Input Karyawan</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="dataCuti.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Input Data Karyawan</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-lg-10 col-6">
              ...
              <div class="card-header">
                <h3 class="card-title">From input Data Manager</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="no_tlp" placeholder="Masukan No Telepon">
                  </div>
                <!-- /.card-body -->
